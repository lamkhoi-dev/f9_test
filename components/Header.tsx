        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              title={isKeySet ? 'API Key: Active' : 'Set API Key'}
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-xs font-bold transition-all transform hover:scale-105 ${
                isKeySet
                  ? 'bg-emerald-600/20 text-emerald-400 border-emerald-500/30 hover:bg-emerald-600/30'
                  : 'bg-red-600/20 text-red-400 border-red-500/30 hover:bg-red-600/30 animate-pulse'
              }`}
            >
              <span className="text-sm leading-none">🔑</span>
              <span>{isKeySet ? 'Key ✓' : 'Set Key'}</span>
            </button>
