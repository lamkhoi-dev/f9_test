      ...
      const response = await ai.models.generateContent({
        ...
        config: {
          ...
          responseSchema: {
            type: Type.OBJECT,
            properties: {
              item1: { type: Type.OBJECT, properties: { hex: { type: Type.STRING }, material: { type: Type.STRING }, color: { type: Type.STRING }, texture: { type: Type.STRING }, finish: { type: Type.STRING }, reflection: { type: Type.STRING } } },
              item2: { type: Type.OBJECT, properties: { hex: { type: Type.STRING }, material: { type: Type.STRING }, color: { type: Type.STRING }, texture: { type: Type.STRING }, finish: { type: Type.STRING }, reflection: { type: Type.STRING } } },
              item3: { type: Type.OBJECT, properties: { hex: { type: Type.STRING }, material: { type: Type.STRING }, color: { type: Type.STRING }, texture: { type: Type.STRING }, finish: { type: Type.STRING }, reflection: { type: Type.STRING } } },
              item4: { type: Type.OBJECT, properties: { hex: { type: Type.STRING }, material: { type: Type.STRING }, color: { type: Type.STRING }, texture: { type: Type.STRING }, finish: { type: Type.STRING }, reflection: { type: Type.STRING } } },
              item5: { type: Type.OBJECT, properties: { hex: { type: Type.STRING }, material: { type: Type.STRING }, color: { type: Type.STRING }, texture: { type: Type.STRING }, finish: { type: Type.STRING }, reflection: { type: Type.STRING } } },
            }
          }
        }
      });
